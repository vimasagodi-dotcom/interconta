$body = '{"id":"8c933b88-ce69-4c66-b3f3-d440e05d457d", "name":"Vitor Manuel dos Santos Gomes Dias", "email":"vimasagodi@gmail.com", "phone":"968070090", "role":"colaborador", "status":"ativo"}'
try {
